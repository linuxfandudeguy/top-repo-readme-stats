...
<a href="https://vercel.com">
  ...
  > This API uses caching by using **`node-cache`** and caches 10 minutes in order to prevent GitHub API limits, meaning the statistics might not update in real time.
